...
function HeroBanner() {
    ...
    return(
        <div className='heroBanner'>
            ...
            <h2 className='nameIntro second'>I turn ideas into <br /><TextAnimation /></h2>
            <p className='blueLetters paragraph'>I'm a full-stack developer located in the US. I'm passionate in creating beautiful applications/UI for everyone to experience.</p>
